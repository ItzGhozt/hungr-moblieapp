...
class FridgeViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        fridgeView.tableViewItems.delegate = self
        fridgeView.tableViewItems.dataSource = self
    ...
    @objc func onAddItemTapped() {
        ...
        alert.addTextField { textField in
            textField.placeholder = "Quantity (e.g., 2 lbs, 1 carton)"
        }
    ...
    func createItem(name: String, quantity: String, expiryDate: String?) {
        ...
        let docRef = database.collection("fridge_items").document()
    ...
    func loadItems() {
        ...
        database.collection("fridge_items")
            ...
            .getDocuments { [weak self] snapshot, error in
                ...
                DispatchQueue.main.async {
                    self?.fridgeView.tableViewItems.reloadData()
                }
            }
    }
    ...
    func deleteItem(itemId: String) {
        ...
        alert.addAction(UIAlertAction(title: "Delete", style: .destructive) { [weak self] _ in
            self?.database.collection("fridge_items").document(itemId).delete { error in
                if let error = error {
...
extension FridgeViewController: UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: "fridgeItem", for: indexPath) as! FridgeItemTableViewCell
...
extension FridgeViewController: FridgeItemTableViewCellDelegate {
