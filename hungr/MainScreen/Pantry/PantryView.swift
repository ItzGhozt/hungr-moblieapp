...
class PantryView: UIView {
    ...
    override init(frame: CGRect) {
        ...
        self.backgroundColor = UIColor(red: 1.0, green: 0.98, blue: 0.94, alpha: 1.0)
    ...
    func setupTitleLabel() {
        labelTitle = UILabel()
        labelTitle.text = "Your Pantry Items"
    ...
    func setupTableViewItems() {
        ...
        tableViewItems.register(PantryItemTableViewCell.self, forCellReuseIdentifier: "pantryItem")
