//
//  FreezerItemTableViewCellDelegate.swift
//  hungr
//
...
//  hungr
//
//  Freezer item table view cell
//

import UIKit

protocol FreezerItemTableViewCellDelegate: AnyObject {
    func deleteButtonTapped(for itemId: String)
}

class FreezerItemTableViewCell: UITableViewCell {
    ...
    weak var delegate: FreezerItemTableViewCellDelegate?
    var itemId: String = ""
